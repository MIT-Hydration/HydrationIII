...
_HEARTBEATREPLY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='last_weight_on_bit_heater_timestamp', full_name='mission_control.HeartBeatReply.last_weight_on_bit_heater_timestamp', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='weight_on_bit_heater_N', full_name='mission_control.HeartBeatReply.weight_on_bit_heater_N', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='torque_z1_percent', full_name='mission_control.HeartBeatReply.torque_z1_percent', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='torque_z2_percent', full_name='mission_control.HeartBeatReply.torque_z2_percent', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='torque_y_percent', full_name='mission_control.HeartBeatReply.torque_y_percent', index=20,
...
_CORESENSORSHEARTBEATRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='last_power_meter_timestamp', full_name='mission_control.CoreSensorsHeartBeatResponse.last_power_meter_timestamp', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='power_W', full_name='mission_control.CoreSensorsHeartBeatResponse.power_W', index=16,
      number=61, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='total_current_mA', full_name='mission_control.CoreSensorsHeartBeatResponse.total_current_mA', index=17,
      number=62, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='server_version', full_name='mission_control.CoreSensorsHeartBeatResponse.server_version', index=18,
